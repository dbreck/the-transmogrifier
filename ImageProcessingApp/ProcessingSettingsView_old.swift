...
struct ProcessingSettingsView: View {
    ...
    var body: some View {
            ...
            HStack(spacing: Spacing.lg) {
                ...
                VStack(alignment: .leading, spacing: Spacing.xs) {
                    ...
                    HStack(spacing: Spacing.sm) {
                        ...
                        TransmogrifierButton("Browse", style: .outline) {
                            selectOutputFolder()
                        }
                    }
                }
                ...
                VStack(alignment: .leading, spacing: Spacing.xs) {
                    ...
                    HStack(spacing: Spacing.sm) {
                        Picker("Choose preset...", selection: $selectedPreset) {
                        ...
                        TransmogrifierButton("Apply", style: .secondary) {
                            applySelectedPreset()
                        }
                        .disabled(selectedPreset.isEmpty)
                        
                        TransmogrifierButton("Save", style: .outline) {
                            showingSavePresetAlert = true
                        }
                    }
                }
        ...
        .alert("Output Folder Required", isPresented: $showingOutputFolderAlert) {
            ...
            Text("Please specify an output folder before processing images.")
        }
    }
    ...
    private func applySelectedPreset() {
        guard !selectedPreset.isEmpty,
              let preset = presetManager.presets.first(where: { $0.id.uuidString == selectedPreset }) else { return }
